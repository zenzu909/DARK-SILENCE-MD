...
module.exports = {
    SESSION_ID: process.env.SESSION_ID || "DARK-SILENCE-MD~rE4QkIKa#UyXAq4V1UCFUva3TIAkbasIC6bDvUHmeMWXTieycD70",
    CAPTION: process.env.CAPTION || "POWERED BY zenzu",
    ...
    OWNER_NUMBER: process.env.OWNER_NUMBER || "94741281478",
    OWNER_NAME: process.env.OWNER_NAME || "seneth",
